...
CREATE TABLE `transfers` (
  ...
  KEY `FK_recipient_account_id` (`recipient_account_id`),
  CONSTRAINT `FK_recipient_account_id` FOREIGN KEY (`recipient_account_id`) REFERENCES `accounts` (`account_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_transaction_id` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`transaction_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-28  0:05:36
